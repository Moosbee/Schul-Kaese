...
<body>
    ...
    <div class="card">
        ...
        <div class="card">
            <div class="container">
                <h4><b>Cardausgabe aut der Hauptseite</b></h4>
                <p>Test</p>
            </div>
        </div>
        <div class="card">
            <div class="container">
                <h4><b>Große Cardausgabe</b></h4>
                <p>Test</p>
            </div>
        </div>
        <div class="card">
            <div class="container">
                <h4><b>Löschen<br><i class="fas fa-trash-alt"></i></b></h4>
                <p>Test</p>
            </div>
        </div>
        <div class="card">
            <div class="container">
                <h4><b><i class="fas fa-cheese"></i><sup><i class="fas fa-plus"></i></sup>Hinzufügen</b></h4>
                <p>Test</p>
            </div>
        </div>
    </section>
